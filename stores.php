...
<head>
    ...
    <meta name="description" content="หาซื้อผลิตภัณฑ์ของโอราทูได้ตามร้านค้าทั่วไป ไม่ว่าจะเป็น วัตสัน ซูรูฮะ ท็อปส์ และอื่นๆอีกมากมาย">
    <meta name="keyword" content="โอราทู,ยาสีฟัน,น้ำยาบ้วนปาก,แปรงสีฟัน,สเปรย์,ขจัดคราบฟัน,อ่อนโยนต่อผิวฟัน,ลมหายใจหอมสดชื่น,ช่องปาก,ฟัน,ยาสีฟันไวท์เทนนิ่ง,ญี่ปุ่น,ปากและฟัน,มั่นใจ,รอยยิ้ม,ฟันสวย,ฟันขาว,คราบฟัน,ผลิตภัณฑ์,อันดับหนึ่ง,ร้านค้า,ซื้อที่ไหน,มีขายที่ไหน,หาซื้อ,อยากได้">

   <title>Stores | Ora² SUNSTAR Thailand</title>
